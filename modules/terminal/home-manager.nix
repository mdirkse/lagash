{ inputs, lib, config, pkgs, ... }: {
  ...
  xdg.configFile."fish/conf.d/atuin.fish".source = ./resources/fish/conf.d/atuin.fish;
  xdg.configFile."fish/conf.d/autostart-sway.fish".source = ./resources/fish/conf.d/autostart-sway.fish;
